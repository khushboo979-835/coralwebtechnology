    ...
    <section class="py-5">
        <div class="container">
                ...
                <div class="col-md-6">
                    <ol>
                        ...
                        <li class="list-group-item">3 SEO-Optimized Structure: Basic SEO setup to increase
                            discoverability. </li>
                        <li class="list-group-item">4 Plugin IntegraƟon: Essential plugins for security, SEO, and
                            performance. </li>
                ...
                <div class="col-md-6">
                    <ol>
                        ...
                        <li class="list-group-item">Professional Copywriting: Engaging and original content aligned with
                            your brand voice.</li>
                        <li class="list-group-item">Content Optimization: Structured to meet SEO requirements.</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="py-3 bg-light">
                ...
                <div class="py-1">
                    <h5 class="py-2 text-success">Website Designing :- ₹14,000 </h5>
                    <h5 class="py-2 text-success">Content Creation (Optional) :- ₹1,000
                    </h5>
                    <li class="list-group-item">Total (with content creation): ₹15,000</li>
                    <li class="list-group-item">Total (without content creation): ₹14,000</li>
                </div>
            </div>
        </div>
    </section>
