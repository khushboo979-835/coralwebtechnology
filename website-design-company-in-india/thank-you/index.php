...
<head>
    ...
    $page_description = 'Thank you for reaching out to Coral Web Technology. We have successfully received your web design inquiry and will contact you shortly.';
    $page_canonical = $base_url . 'website-design-company-in-india/thank-you/';
    ?>
        ...
        <div class="container d-flex justify-content-center">
            <div class="thank-you-card">
                ...
                <p class="text-muted px-md-4">
                    Thank you for showing interest in our <strong>Web Design Services</strong>. Our team is preparing a custom website UI/UX evaluation and audit report tailored to your business needs. We will connect with you within 24 hours.
                </p>
                ...
                <div class="process-steps">
                    ...
                    <div class="step-item active">
                        ...
                        <div class="step-title">UI/UX Audit</div>
                    </div>
                    <div class="step-item">
                        <div class="step-badge">3</div>
                        <div class="step-title">Custom Quote</div>
                    </div>
                </div>
                ...
                <div class="cta-group">
                    ...
                    <a href="https://wa.me/919117741984?text=Hi%20Coral%20Web%20Technology,%20I%20just%20submitted%20a%20web%20design%20enquiry" class="btn-theme-primary" target="_blank">
