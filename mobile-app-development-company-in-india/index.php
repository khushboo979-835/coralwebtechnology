...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18166869944"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'AW-18166869944');
    </script>
    <?php
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center gap-2 gap-sm-3">
                    ...
                    <a href="https://wa.me/919117741984?text=Hi%20Coral%20Web%20Technology,%20I%20want%20to%20book%20a%20meeting%20for%20Mobile%20App%20Development" class="btn-book-mobile d-inline-flex d-md-none" target="_blank">
                ...
                <div class="col-lg-5">
                    <div class="minimal-form-card" id="lead-form">
                        ...
                        <form action="../send-mail.php" method="post">
                            ...
                            <div class="form-group">
                                <textarea name="requirement" rows="2" placeholder="Let us know a bit more about the project you have in mind..."></textarea>
                            </div>
