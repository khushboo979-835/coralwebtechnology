        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="head-title text-center mb-4">
                    <h2>Website Design & Development on WordPress (Dynamic Website) </h2>
                </div>
                ...
                <div class="col-md-6">
                    <ol>
                        <li class="list-group-item">1 Custom Design: A unique layout that aligns with your brand’s
                            vision </li>
                        <li class="list-group-item">2 Responsive Layout: Optimized for all devices (desktop, tablet, and
                            mobile). </li>
                ...
                <div class="col-md-6">
                    <ol>
                        ...
                        <li class="list-group-item">Professional CopywriƟng: Engaging and original content aligned with
                            your brand voice.
                        </li>
                        <li class="list-group-item">Content OpƟmizaƟon: Structured to meet SEO requirements.</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="py-3 bg-light">
                ...
                <div class="py-1">
                    <h5 class="py-2 text-success">Website Designing :- ₹10,000 </h5>
                    <h5 class="py-2 text-success">Content Creation (Optional) :- ₹1,000
                    </h5>
                    <li class="list-group-item">Total (with content creation): ₹10,000</li>
                    <li class="list-group-item">Total (without content creation): ₹9,000</li>
                </div>
            </div>
        </div>
    </section>
