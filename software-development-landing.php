...
<head>
    ...
    $page_canonical = $base_url . 'software-development-landing.php';
    ?>
<?php include 'common/config.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <?php
    $page_title = 'Custom Software Development Company | ERP CRM Billing Software';
    $page_description = 'We design and build custom ERP, CRM, Billing and School Management software solutions.';
    $page_keywords = 'custom software development company, ERP development, CRM development, school management software';
    $page_canonical = $base_url . 'software-development-landing.php';
    ?>
